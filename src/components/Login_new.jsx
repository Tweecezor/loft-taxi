        ...
        <section className = 'background'>
            ...
            <div className = 'login'>
                ...
                <form action="" className = 'login__form' onSubmit = {submitForm}>
                    ...
                    <input className = 'login__form-submit' type="submit" value = 'Войти' onClick = {()=> context.login(name,password)}/>
                </form>
            </div>  
        </section>
    )
